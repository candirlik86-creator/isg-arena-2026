      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-white/25 bg-white/[0.14] p-6 shadow-2xl shadow-blue-950/25 backdrop-blur md:p-8">
        ...
        <div className="relative">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <div className="rounded-2xl border border-emerald-100/45 bg-emerald-300/20 px-5 py-4 text-right shadow-xl shadow-blue-900/15">
              ...
              return (
                <article
                  ...
                  className={`relative overflow-hidden rounded-[1.5rem] border p-5 transition ${
                    isCorrect
                      ? "border-emerald-100/80 bg-emerald-400/20 shadow-2xl shadow-emerald-500/20 ring-2 ring-emerald-300/25"
                      : styles.muted
                  }`}
                >
                  <div className="relative grid gap-5 md:grid-cols-[minmax(0,1fr)_300px] md:items-center">
                    <div className="flex min-w-0 items-center gap-5">
                      <div
                        className={`flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl border text-4xl font-black shadow-xl ${
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-3">
                          <p className="text-3xl font-black leading-tight text-white md:text-4xl">{option.text}</p>
                          {isCorrect ? (
                        ...
                        <div className="mt-5 h-8 overflow-hidden rounded-full border border-white/20 bg-white/25 shadow-inner">
                          <div
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="min-w-0 rounded-2xl border border-white/20 bg-white/[0.12] px-4 py-4 text-center">
                        <p className="text-xs font-black uppercase tracking-[0.22em] text-cyan-100">Cevap</p>
                        <p className="mt-2 text-4xl font-black tabular-nums text-white lg:text-5xl">{count}</p>
                      </div>
                      <div className="min-w-0 rounded-2xl border border-white/20 bg-white/[0.12] px-4 py-4 text-center">
                        <p className="text-xs font-black uppercase tracking-[0.22em] text-cyan-100">Oran</p>
                        <p className={`mt-2 text-4xl font-black tabular-nums lg:text-5xl ${isCorrect ? "text-emerald-100" : "text-white"}`}>
