...
export function QuestionCard({ question, showOptions = true, compact = false, showCorrectAnswer = false, selectedOptionId }: QuestionCardProps) {
  return (
    <article className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-slate-950/80 p-6 shadow-2xl shadow-black/40 backdrop-blur md:p-10">
      ...
      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <StageBadge label={`Soru ${question.quizNumber} / 10`} />
